...
const AboutMe: FunctionComponent<AboutMeType> = ({ className = "" }) => {
    return (
            ...
            <div className={styles.aboutContent}>
                ...
                <div className={styles.aboutContact}>
                    ...
                    <a
                        ...
                        download="samclastine_resume.pdf"
